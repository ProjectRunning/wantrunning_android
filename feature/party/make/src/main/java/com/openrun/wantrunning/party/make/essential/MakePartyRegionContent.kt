...
fun MakePartyRegionContent(
    ...
    Column(
        ...
        TextFieldTitleText(
            title = stringResource(id = com.openrun.wantrunning.party.make.R.string.make_party_region),
...
private fun MakePartyRegionTextField(
    ...
    Row(modifier = modifier, verticalAlignment = Alignment.CenterVertically) {
        BoxedTextField(
            value = address,
            hint = stringResource(id = com.openrun.wantrunning.party.make.R.string.make_party_region_hint),
            readOnly = true,
