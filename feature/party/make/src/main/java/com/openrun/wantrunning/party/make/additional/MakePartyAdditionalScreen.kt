...
import com.openrun.wantrunning.base.ui.compose.Gray20
import com.openrun.wantrunning.base.ui.compose.Gray5
...
fun MakePartyAdditionalScreen(
    ...
    var timeTaken: String? by remember { mutableStateOf(null) }
...
private fun MakePartyAdditionalButtonContainer(
    ...
    Row(modifier = modifier, horizontalArrangement = Arrangement.spacedBy(space = 8.dp)) {
        BasicButton(
            text = stringResource(id = com.openrun.wantrunning.base.ui.R.string.all_skip),
        ...
        BasicButton(
            text = stringResource(id = com.openrun.wantrunning.base.ui.R.string.all_done),
